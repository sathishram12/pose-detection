...
def joints_to_point8(joints, num_p=17):
    """
...
def point8_to_joints(points, num_p=17):
    """
...
class ScaleAug(ImageAugmentor):
    ...
    def get_transform(self, meta):
        ...
        scale = self.target_dist * scale_multiplier
...
class RotateAug(ImageAugmentor):
    ...
    def get_transform(self, meta):
        ...
        R = cv2.getRotationMatrix2D((center_x, center_y), int(deg), 1.0)
